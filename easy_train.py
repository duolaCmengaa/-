...
# 如果要测试，激活函数全部字母要小写
east_model = model1.Model(hidden_layers=(256, 128), activation=('sigmoid', 'relu', 'softmax'),input_size=784,output_size=10, lambda1=0.0001)

# 如果要保存，令save=True
east_model.train(X_train1, y_train1, X_valid, y_valid, learningrate=0.01, batch_size=32, decay_number=0.9999, epochs=3, start_up=250, min_lr=1e-4, save=True, result_dir=save_path0)
